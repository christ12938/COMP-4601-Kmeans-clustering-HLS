...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module kmeans_y_data_V_rom (
...
initial begin
    $readmemh("./kmeans_y_data_V_rom.dat", ram0);
    $readmemh("./kmeans_y_data_V_rom.dat", ram1);
end
...
kmeans_y_data_V_rom kmeans_y_data_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
