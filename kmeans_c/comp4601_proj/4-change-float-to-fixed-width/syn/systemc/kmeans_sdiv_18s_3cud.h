...
// ==============================================================
#ifndef __kmeans_sdiv_18s_3cud__HH__
#define __kmeans_sdiv_18s_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_sdiv_18s_3cud) {
    ...
    SC_CTOR(kmeans_sdiv_18s_3cud):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
