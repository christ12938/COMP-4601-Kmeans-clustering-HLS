...
// ==============================================================
#ifndef __kmeans_mul_72ns_1wdI__HH__
#define __kmeans_mul_72ns_1wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_72ns_1wdI) {
    ...
    SC_CTOR(kmeans_mul_72ns_1wdI):  ACMP_mul_us_U ("ACMP_mul_us_U") {
