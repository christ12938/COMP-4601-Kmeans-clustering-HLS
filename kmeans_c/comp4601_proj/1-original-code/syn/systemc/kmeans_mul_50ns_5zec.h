...
// ==============================================================
#ifndef __kmeans_mul_50ns_5zec__HH__
#define __kmeans_mul_50ns_5zec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_50ns_5zec) {
    ...
    SC_CTOR(kmeans_mul_50ns_5zec):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
