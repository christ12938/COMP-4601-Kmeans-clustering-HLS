...
// ==============================================================
#ifndef __kmeans_mul_83ns_6qcK__HH__
#define __kmeans_mul_83ns_6qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_83ns_6qcK) {
    ...
    SC_CTOR(kmeans_mul_83ns_6qcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
