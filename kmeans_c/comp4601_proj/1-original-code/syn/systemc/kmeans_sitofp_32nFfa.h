...
// ==============================================================
#ifndef __kmeans_sitofp_32nFfa__HH__
#define __kmeans_sitofp_32nFfa__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_sitofp_32nFfa) {
    ...
    SC_CTOR(kmeans_sitofp_32nFfa):  ACMP_sitofp_U ("ACMP_sitofp_U") {
