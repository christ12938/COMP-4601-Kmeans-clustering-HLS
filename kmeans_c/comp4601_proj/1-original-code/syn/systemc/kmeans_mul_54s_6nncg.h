...
// ==============================================================
#ifndef __kmeans_mul_54s_6nncg__HH__
#define __kmeans_mul_54s_6nncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_54s_6nncg) {
    ...
    SC_CTOR(kmeans_mul_54s_6nncg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
