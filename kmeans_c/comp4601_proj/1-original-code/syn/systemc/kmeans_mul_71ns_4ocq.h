...
// ==============================================================
#ifndef __kmeans_mul_71ns_4ocq__HH__
#define __kmeans_mul_71ns_4ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_71ns_4ocq) {
    ...
    SC_CTOR(kmeans_mul_71ns_4ocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
