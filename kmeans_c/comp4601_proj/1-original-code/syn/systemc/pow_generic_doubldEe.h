...
// ==============================================================
#ifndef __pow_generic_doubldEe_H__
#define __pow_generic_doubldEe_H__
...
struct pow_generic_doubldEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doubldEe_ram) {
...
SC_MODULE(pow_generic_doubldEe) {
...
pow_generic_doubldEe_ram* meminst;


SC_CTOR(pow_generic_doubldEe) {
meminst = new pow_generic_doubldEe_ram("pow_generic_doubldEe_ram");
