...
// ==============================================================
#ifndef __kmeans_fpext_32nsHfu__HH__
#define __kmeans_fpext_32nsHfu__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_fpext_32nsHfu) {
    ...
    SC_CTOR(kmeans_fpext_32nsHfu):  ACMP_fpext_U ("ACMP_fpext_U") {
