...
// ==============================================================
#ifndef __kmeans_mul_43ns_3xdS__HH__
#define __kmeans_mul_43ns_3xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_43ns_3xdS) {
    ...
    SC_CTOR(kmeans_mul_43ns_3xdS):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
