...
// ==============================================================
#ifndef __kmeans_mul_49ns_4yd2__HH__
#define __kmeans_mul_49ns_4yd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_49ns_4yd2) {
    ...
    SC_CTOR(kmeans_mul_49ns_4yd2):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
