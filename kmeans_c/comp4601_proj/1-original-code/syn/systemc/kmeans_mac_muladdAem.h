...
// ==============================================================
#ifndef __kmeans_mac_muladdAem__HH__
#define __kmeans_mac_muladdAem__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mac_muladdAem) {
    ...
    SC_CTOR(kmeans_mac_muladdAem):  simcore_mac_0_U ("simcore_mac_0_U") {
