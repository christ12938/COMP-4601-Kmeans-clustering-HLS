...
// ==============================================================
#ifndef __kmeans_fptrunc_64Gfk__HH__
#define __kmeans_fptrunc_64Gfk__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_fptrunc_64Gfk) {
    ...
    SC_CTOR(kmeans_fptrunc_64Gfk):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
