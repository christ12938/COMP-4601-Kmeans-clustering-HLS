...
// ==============================================================
#ifndef __kmeans_mul_77ns_6udo__HH__
#define __kmeans_mul_77ns_6udo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_77ns_6udo) {
    ...
    SC_CTOR(kmeans_mul_77ns_6udo):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
