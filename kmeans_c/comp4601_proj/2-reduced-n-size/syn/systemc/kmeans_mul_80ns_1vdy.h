...
// ==============================================================
#ifndef __kmeans_mul_80ns_1vdy__HH__
#define __kmeans_mul_80ns_1vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_80ns_1vdy) {
    ...
    SC_CTOR(kmeans_mul_80ns_1vdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
