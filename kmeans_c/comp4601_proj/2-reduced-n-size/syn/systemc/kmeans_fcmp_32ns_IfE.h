...
// ==============================================================
#ifndef __kmeans_fcmp_32ns_IfE__HH__
#define __kmeans_fcmp_32ns_IfE__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_fcmp_32ns_IfE) {
    ...
    SC_CTOR(kmeans_fcmp_32ns_IfE):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
