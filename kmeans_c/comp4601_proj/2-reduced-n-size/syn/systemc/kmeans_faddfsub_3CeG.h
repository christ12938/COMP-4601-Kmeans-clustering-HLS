...
// ==============================================================
#ifndef __kmeans_faddfsub_3CeG__HH__
#define __kmeans_faddfsub_3CeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_faddfsub_3CeG) {
    ...
    SC_CTOR(kmeans_faddfsub_3CeG):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
