...
// ==============================================================
#ifndef __kmeans_mul_73ns_6pcA__HH__
#define __kmeans_mul_73ns_6pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_73ns_6pcA) {
    ...
    SC_CTOR(kmeans_mul_73ns_6pcA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
