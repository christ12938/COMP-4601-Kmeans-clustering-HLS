...
// ==============================================================
#ifndef __kmeans_mul_92ns_6rcU__HH__
#define __kmeans_mul_92ns_6rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_92ns_6rcU) {
    ...
    SC_CTOR(kmeans_mul_92ns_6rcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
