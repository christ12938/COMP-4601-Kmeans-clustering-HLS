...
// ==============================================================
#ifndef __kmeans_mul_87ns_6sc4__HH__
#define __kmeans_mul_87ns_6sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_87ns_6sc4) {
    ...
    SC_CTOR(kmeans_mul_87ns_6sc4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
