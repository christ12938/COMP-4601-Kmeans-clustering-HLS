...
// ==============================================================
#ifndef __kmeans_mul_82ns_6tde__HH__
#define __kmeans_mul_82ns_6tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmeans_mul_82ns_6tde) {
    ...
    SC_CTOR(kmeans_mul_82ns_6tde):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
